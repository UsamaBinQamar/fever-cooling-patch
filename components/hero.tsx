        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              ...
              <span className="text-blue-600 dark:text-blue-400">Fever Relief</span>
            </h1>
            <p className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-xl">
              Our medical-grade cooling patches provide immediate and long-lasting relief for fevers, helping you and your family recover faster.
            </p>
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200">Clinically Tested</span>
              </div>
              <div className="flex items-center space-x-2">
                <Clock className="h-6 w-6 text-blue-600 dark:text-blue-400" />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200">8+ Hours Relief</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="h-6 w-6 text-blue-600 dark:text-blue-400" />
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200">Dermatologist Approved</span>
              </div>
            </div>
          </motion.div>
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white dark:bg-gray-800 rounded-lg p-4 shadow-lg">
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Temperature reduction in minutes</p>
                </div>
              </div>
            </div>
          </motion.div>
